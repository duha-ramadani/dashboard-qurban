...
import { Beef, Users, PackageOpen, Wallet, CheckCircle, Clock } from "lucide-react";
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {[
                { label: "Belum Disembelih", value: stats.hewanBelumDisembelih, total: stats.totalHewan, color: "bg-amber-400", badge: "yellow" as const },
                { label: "Sudah Disembelih", value: stats.hewanSudahDisembelih, total: stats.totalHewan, color: "bg-green-500", badge: "green" as const },
